...
<body>
    ...
    <input type="text" name="fName" placeholder = "Enter your First Name"><span class = "error">*<?php echo $firstNameErr?></span> <br> <br>
    <input type="text" name="lName" placeholder = "Enter your Last Name"><span class = "error">*<?php echo $lastNameErr?></span> <br> <br>
