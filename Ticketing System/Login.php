...
?>
    ...
    if(session_status() == 0){ echo "The  Session[name: $sessUser] is currently : Disabled"; }
    else if (session_status() == 1){ echo "The Session[name: $sessUser] is currently : None"; }
    elseif(session_status() == 2){ echo "The Session[name: $sessUser] is currently : Active"; } 
    else{ echo "The session is currently : Unknown";}
    }else{ echo "<span style=color:Maroon;>"."The session ".$sessUser." is logged out, Please login to continue"."</span>";; }
    ?>
