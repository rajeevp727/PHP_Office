		...
		?>
			...
			<a class="sidebar-toggle d-flex">
          	<i class="hamburger align-self-center"></i>
				...
				if($result = mysqli_query($conn, $sqlUsers)){
					$noOfUsers = mysqli_num_rows($result);
				}
				$sqlCateg = "SELECT * FROM Categories";
				if($result = mysqli_query($conn, $sqlCateg)){
					$noOfCateg = mysqli_num_rows($result);
				}
				$sqlProd = "SELECT * FROM Products";
				if($result = mysqli_query($conn, $sqlProd)){
					...
					<div class="card-body">
							...
							<div class="w-100">
								<div class="row">
									<div class="col-sm-6">
										<div class="card">
											<div class="card-body">
												<h5 class="card-title mb-4">Number of Users:</h5>
												<h1 class="mt-1 mb-3"><?php echo $noOfUsers; ?></h1>
											</div>
										</div>
										<div class="card">
											<div class="card-body">
												<h5 class="card-title mb-4">Number of Categories:</h5>
												<h1 class="mt-1 mb-3"><?php echo $noOfCateg; ?></h1>
											</div>
										</div>
									</div>
									<div class="col-sm-6">
										<div class="card">
											<div class="card-body">
												<h5 class="card-title mb-4">Number of Products:</h5>
												<h1 class="mt-1 mb-3"><?php echo $noOfProd; ?></h1>
											</div>
										</div>
										<div class="card">
											<div class="card-body">
												<h5 class="card-title mb-4">Random Number:</h5>
												<h1 class="mt-1 mb-3"><?php echo rand(0, 1000);?></h1>
											</div>
										</div>
									</div>
								</div>
						...
						<div class="col-xl-6 col-xxl-7" >
							<div class="card flex-fill w-100">
								...
								<!-- <?php // $date = date('Format String', time()); echo $date ?> -->
								<div class="card-body py-3">
									<div class="chart chart-sm">
									<h1 class="mt-1 mb-3"><?php echo date("Y/m/d");?></h1>
